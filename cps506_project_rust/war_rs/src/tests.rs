...
mod tests {
    ...
    const T6: [u8; 52] = [5, 6, 9, 9, 7, 7, 6, 6, 6, 5, 13, 12, 10, 11, 1, 2, 7, 8, 8, 9, 9, 5, 5, 8, 8, 7, 1, 4, 4, 3, 13, 11, 13, 11, 12, 4, 10, 11, 1, 1, 13, 10, 2, 10, 4, 3, 2, 2, 3, 12, 3, 12];
    const R6: [u8; 52] = [10, 3, 4, 2, 13, 2, 11, 2, 13, 8, 11, 5, 1, 8, 1, 9, 9, 8, 5, 4, 13, 7, 12, 4, 13, 10, 12, 7, 9, 3, 9, 2, 7, 6, 6, 5, 10, 8, 1, 11, 12, 6, 1, 7, 12, 6, 10, 3, 11, 5, 4, 3];
